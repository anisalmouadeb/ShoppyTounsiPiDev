...
public class PaypalClientE {
	...
	public Map<String, Object> createPayment(PaymentRequestE paymentRequest){
	...
	public Map<String, Object> completePayment(CompletePaymentRequestE completePaymentRequest){
